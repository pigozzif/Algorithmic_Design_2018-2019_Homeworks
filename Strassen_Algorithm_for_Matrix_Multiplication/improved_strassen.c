 ...
 * 1/7th of the total the space for the array of matrices P. In fact, we can store
 * four of the 7 Ps each in one of the Cs, and then use an auxiliary matrix to sum/substract
 * the remaining one after the other
 */
               ...
               const size_t n)
{
  ...
  // auxiliary matrix to be used in the following
  // notice it is 1/7th of the original P, reducing memory
  // consumption
  ...
  // by summing the other three Cs to the existing C11.
  ...
  // C22 = P5 + P1 - P3 - P7, by means of aux
  sub_matrix_blocks(C, C2X, CX2,
                    C, C2X, CX2,
                    aux, 0, 0,
                    n2);
